...
|         | Kinetic | Melodic |
|:-------:|:------:|:----:|
| Branch  | [`kinetic-devel`](https://github.com/ros-industrial/universal_robot/tree/kinetic-devel) | [`melodic-devel`](https://github.com/ros-industrial/universal_robot/tree/melodic-devel) | 
| Status  |  supported | supported 
| Version | [version](http://repositories.ros.org/status_page/ros_kinetic_default.html?q=universal_robot) | [version](http://repositories.ros.org/status_page/ros_melodic_default.html?q=universal_robot) |
...
|:-------:|:-------------------:|:-------------------:|
| universal_robot | [![released](http://build.ros.org/buildStatus/icon?job=Ksrc_uX__universal_robot__ubuntu_xenial__source)](http://build.ros.org/view/Ksrc_uX/job/Ksrc_uX__universal_robot__ubuntu_xenial__source/) | [![released](http://build.ros.org/buildStatus/icon?job=Kbin_uX64__universal_robot__ubuntu_xenial_amd64__binary)](http://build.ros.org/view/Kbin_uX64/job/Kbin_uX64__universal_robot__ubuntu_xenial_amd64__binary/) |
